...
class Publisher(models.Model):
    name = models.CharField(max_length=20, help_text=" Ввкдите наименование издательства", verbose_name="Издательство")
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, help_text="Введите инвентраный номер экземпояра",
